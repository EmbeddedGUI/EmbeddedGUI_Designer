...
Use `Build -> Release History...` to inspect, filter, and refresh prior release metadata, SDK revisions, and preview manifests or build logs directly inside the Designer.
