...
- `Simple` mode adds quick helpers for importing individual images/fonts/videos, scanning an asset folder, generating font text files, and opening or creating linked font text resources.
