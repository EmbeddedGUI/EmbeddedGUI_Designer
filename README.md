...
- `Simple` mode also previews the selected asset, renders font samples directly in the window, and can remove, open, resize, or rotate images for quick touch-up.
