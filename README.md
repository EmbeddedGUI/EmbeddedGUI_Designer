...
Use `Build -> Release History...` to inspect, filter, refresh, and copy prior release summaries, SDK revisions, and preview manifests or build logs directly inside the Designer.
