...
Use `Build -> Release History...` to inspect, time-filter, refresh, copy, or export prior release summaries or entry JSON, preview manifests or build logs directly inside the Designer, and reopen with the last-used filters still applied.
