...
The latest successful build can be reopened from `Build -> Open Last Release Folder`, `Build -> Open Last Release Dist`, `Build -> Open Last Release Manifest`, or `Build -> Open Last Release Version`.
