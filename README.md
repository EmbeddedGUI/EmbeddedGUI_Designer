...
- `Simple` mode also previews the selected asset, renders font samples directly in the window, auto-detects video fps and size, and can remove, open, resize, rotate, or flip images for quick touch-up.
