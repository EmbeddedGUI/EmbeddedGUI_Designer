...
Use `Build -> Release History...` to inspect, filter, refresh, and copy prior release summaries or entry JSON, and preview manifests or build logs directly inside the Designer.
