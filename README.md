...
The latest successful build can be reopened from `Build -> Open Last Release Folder`, `Build -> Open Last Release Dist`, `Build -> Open Last Release Manifest`, `Build -> Open Last Release Version`, or `Build -> Open Last Release Package`.
