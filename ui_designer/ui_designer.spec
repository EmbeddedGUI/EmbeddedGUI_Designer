...
Build command:
    pyinstaller ui_designer/ui_designer.spec --distpath dist --workpath build/pyinstaller --clean
"""
import os
import sys
...
ui_designer_dir = os.path.abspath(SPECPATH)  # ui_designer/
repo_root = os.path.dirname(ui_designer_dir)
