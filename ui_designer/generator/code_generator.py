...
def generate_page_header(page, project):
    ...
    lines.append("// Extend the page via the user-owned *_ext.h and *.c files.")
    lines.append("")
...
def generate_page_layout_source(page, project):
    ...
    lines.append(f"// User logic belongs in {name}.c and {name}_ext.h (never overwritten).")
    lines.append("")
    lines.append('#include "egui.h"')
