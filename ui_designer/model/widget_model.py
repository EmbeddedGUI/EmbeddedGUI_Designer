...
COLOR_RGB = {
    ...
    "EGUI_THEME_SECONDARY": (0x14, 0xB8, 0xA6),
    "EGUI_THEME_SUCCESS": (0x16, 0xA3, 0x4A),
    "EGUI_THEME_WARNING": (0xF5, 0x9E, 0x0B),
    "EGUI_THEME_DANGER": (0xDC, 0x26, 0x26),
    "EGUI_THEME_TRACK_BG": (0xE2, 0xE8, 0xF0),
    "EGUI_THEME_TRACK_BG_DARK": (0xCB, 0xD5, 0xE1),
    "EGUI_THEME_TRACK_OFF": (0xCB, 0xD5, 0xE1),
    "EGUI_THEME_DISABLED": (0xD1, 0xD5, 0xDB),
    "EGUI_THEME_THUMB": (0xFF, 0xFF, 0xFF),
    "EGUI_THEME_TEXT": (0xFF, 0xFF, 0xFF),
    "EGUI_THEME_TEXT_PRIMARY": (0x11, 0x18, 0x27),
    "EGUI_THEME_TEXT_SECONDARY": (0x6B, 0x72, 0x80),
    "EGUI_THEME_SURFACE": (0xFF, 0xFF, 0xFF),
    "EGUI_THEME_SURFACE_VARIANT": (0xF8, 0xFA, 0xFC),
    "EGUI_THEME_BORDER": (0xE2, 0xE8, 0xF0),
    "EGUI_THEME_FOCUS": (0x25, 0x63, 0xEB),
    "EGUI_THEME_PRESS_OVERLAY": (0x00, 0x00, 0x00),
}
