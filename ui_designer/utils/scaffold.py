...
UICODE_DISP_HEADER_FILENAME = "uicode_disp0.h"
...
UICODE_DISP_HEADER_RELPATH = f"{DESIGNER_PROJECT_DIRNAME}/{UICODE_DISP_HEADER_FILENAME}"
...
def sdk_example_build_mk_path(sdk_root: str | None, app_name: str | None) -> str:
...
def sdk_example_paths(sdk_root: str | None, app_name: str | None) -> dict[str, str]:
    ...
    config_dir = project_config_dir(app_dir)
    resource_src_dir = project_resource_src_dir(app_dir)
    return {
        "app_name": normalized_app_name,
        "app_dir": app_dir,
        "config_dir": config_dir,
        "layout_dir": project_config_layout_dir(app_dir),
        "config_resource_dir": project_config_resource_dir(app_dir),
        "resource_images_dir": project_config_images_dir(app_dir),
        "generated_resource_dir": project_generated_resource_dir(app_dir),
        "generated_img_dir": project_generated_img_dir(app_dir),
        "generated_font_dir": project_generated_font_dir(app_dir),
        "resource_src_dir": resource_src_dir,
        "supported_text_path": project_supported_text_path(app_dir),
        "resource_catalog_path": project_resource_catalog_path(app_dir),
        "user_resource_config_path": project_user_resource_config_path(app_dir),
        "designer_resource_config_path": project_designer_resource_config_path(app_dir),
        "app_config_path": project_app_config_path(app_dir),
        "build_mk_path": project_build_mk_path(app_dir),
        "project_path": project_file_path(app_dir, normalized_app_name),
        "reference_frames_dir": project_config_reference_frames_dir(app_dir),
        "regression_report_path": project_config_regression_report_path(app_dir),
        "regression_results_path": project_config_regression_results_path(app_dir),
    }
...
def build_project_model_with_page_widgets_and_materialize_codegen(
    app_name,
    screen_width=240,
    screen_height=320,
    *,
    ...
    """Build a multi-page project model, save it, and materialize generated outputs."""
    project, roots = build_project_model_with_page_widgets(
        app_name,
        screen_width,
        screen_height,
    ...
    if callable(extra_files_builder):
        resolved_extra_files.update(extra_files_builder(project, roots) or {})
    if extra_files:
    ...
    return project, roots, materialized


def build_project_model_only_with_page_widgets_and_materialize_codegen(
    app_name,
    screen_width=240,
    screen_height=320,
    *,
    ...
    """Build a multi-page project model, materialize outputs, and return only the project."""
    return _pick_result_items(
...
def build_project_model_and_page_with_widgets_and_materialize_codegen(
    app_name,
    screen_width=240,
    screen_height=320,
    *,
...
def load_saved_project_model(project_dir):
    """Load a saved project model from a directory or project file path."""
    from ..model.project import Project
...
def materialize_saved_project_codegen_outputs(
    ...
    *,
    ...
    if resolved_project is None:
        resolved_project = load_saved_project_model(project_dir)
...
def build_saved_project_model_with_widgets(
    app_name,
    screen_width=240,
    screen_height=320,
    *,
...
def build_saved_project_model_with_widgets_and_materialize_codegen(
    app_name,
    screen_width=240,
    screen_height=320,
    *,
    ...
    """Build, save, and materialize a single-page project model, returning page and root details."""
    return build_project_model_with_widgets_and_materialize_codegen(
        app_name,
        screen_width,
        screen_height,
        sdk_root=sdk_root,
...
def build_saved_project_model_and_page_with_widgets_and_materialize_codegen(
    app_name,
    screen_width=240,
    screen_height=320,
    *,
    ...
    """Build, save, materialize, and return only the project, page, and generated outputs."""
    return _pick_result_items(
...
def build_saved_project_model_and_root_with_widgets_and_materialize_codegen(
    app_name,
    screen_width=240,
    screen_height=320,
    *,
    ...
    """Build, save, materialize, and return only the project, root widget, and generated outputs."""
    return _pick_result_items(
        build_saved_project_model_with_widgets_and_materialize_codegen(
            app_name,
            screen_width,
...
def build_saved_project_model_only_with_widgets_and_materialize_codegen(
    app_name,
    screen_width=240,
    screen_height=320,
    *,
    ...
    """Build, save, materialize, and return only the project and generated outputs."""
    return _pick_result_items(
        build_saved_project_model_with_widgets_and_materialize_codegen(
            app_name,
            screen_width,
...
def build_saved_project_model_with_page_widgets_and_materialize_codegen(
    app_name,
    screen_width=240,
    screen_height=320,
    *,
    ...
    """Build, save, and materialize a multi-page project model, returning project and page roots."""
    return build_project_model_with_page_widgets_and_materialize_codegen(
        app_name,
        screen_width,
        screen_height,
        sdk_root=sdk_root,
...
def build_saved_project_model_only_with_page_widgets_and_materialize_codegen(
    app_name,
    screen_width=240,
    screen_height=320,
    *,
    ...
    """Build, save, materialize, and return only the multi-page project and generated outputs."""
    return _pick_result_items(
