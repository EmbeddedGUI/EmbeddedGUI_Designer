...
# Canonical semantic IDs map to a glyph plus color token; rendered size is handled centrally.
_ICON_DEFINITIONS = {
    # Toolbar P0
    "toolbar.new": {"glyph": "add_circle", "token": "default"},
    "toolbar.open": {"glyph": "folder_open", "token": "default"},
    "toolbar.save": {"glyph": "save", "token": "default"},
    "toolbar.undo": {"glyph": "undo", "token": "default"},
    "toolbar.redo": {"glyph": "redo", "token": "default"},
    "toolbar.copy": {"glyph": "content_copy", "token": "default"},
    "toolbar.paste": {"glyph": "content_paste", "token": "default"},
    "toolbar.delete": {"glyph": "delete_outline", "token": "default"},
    "toolbar.preview": {"glyph": "visibility", "token": "default"},
    "toolbar.compile": {"glyph": "play_circle", "token": "default"},
    "toolbar.debug": {"glyph": "bug_report", "token": "default"},
    "toolbar.refresh": {"glyph": "refresh", "token": "default"},
    "toolbar.stop": {"glyph": "stop", "token": "default"},
    "toolbar.export": {"glyph": "upload", "token": "default"},
    "toolbar.settings.project": {"glyph": "settings", "token": "default"},
    "toolbar.settings.global": {"glyph": "tune", "token": "default"},

    # Navigation P0
    "nav.project": {"glyph": "folder", "token": "default"},
    "nav.structure": {"glyph": "account_tree", "token": "default"},
    "nav.page": {"glyph": "description", "token": "default"},
    "nav.page_group": {"glyph": "folder", "token": "default"},
    "nav.template": {"glyph": "dashboard", "token": "default"},
    "nav.component_library": {"glyph": "widgets", "token": "default"},
    "nav.resource": {"glyph": "perm_media", "token": "default"},
    "nav.expand": {"glyph": "chevron_right", "token": "muted"},
    "nav.collapse": {"glyph": "expand_more", "token": "muted"},

    # Inspector/layout P0
    "layout.align.left": {"glyph": "format_align_left", "token": "default"},
    "layout.align.center": {"glyph": "format_align_center", "token": "default"},
    "layout.align.right": {"glyph": "format_align_right", "token": "default"},
    "layout.align.top": {"glyph": "vertical_align_top", "token": "default"},
    "layout.align.middle": {"glyph": "vertical_align_center", "token": "default"},
    "layout.align.bottom": {"glyph": "vertical_align_bottom", "token": "default"},
    "layout.distribute.h": {"glyph": "view_week", "token": "default"},
    "layout.distribute.v": {"glyph": "view_stream", "token": "default"},
    "edit.visible": {"glyph": "visibility", "token": "default"},
    "edit.hidden": {"glyph": "visibility_off", "token": "muted"},
    "edit.lock": {"glyph": "lock", "token": "default"},
    "edit.unlock": {"glyph": "lock_open", "token": "default"},

    # State/status
    "state.success": {"glyph": "check_circle", "token": "success"},
    "state.warn": {"glyph": "warning_amber", "token": "warn"},
    "state.error": {"glyph": "error", "token": "error"},
    "state.info": {"glyph": "info", "token": "info"},
    "state.progress": {"glyph": "hourglass_empty", "token": "info"},

    # Canvas operations P1
    "canvas.select": {"glyph": "ads_click", "token": "default"},
    "canvas.drag": {"glyph": "pan_tool", "token": "default"},
    "canvas.zoom_in": {"glyph": "zoom_in", "token": "default"},
    "canvas.zoom_out": {"glyph": "zoom_out", "token": "default"},
    "canvas.rotate": {"glyph": "rotate_right", "token": "default"},
    "canvas.layer.up": {"glyph": "vertical_align_top", "token": "default"},
    "canvas.layer.down": {"glyph": "vertical_align_bottom", "token": "default"},
    "canvas.layer.top": {"glyph": "vertical_align_top", "token": "default"},
    "canvas.layer.bottom": {"glyph": "vertical_align_bottom", "token": "default"},
    "canvas.grid": {"glyph": "grid_view", "token": "muted"},
    "canvas.snap": {"glyph": "my_location", "token": "muted"},
    "canvas.ruler": {"glyph": "straighten", "token": "muted"},
    "canvas.guides": {"glyph": "grid_view", "token": "muted"},
}
...
_FLUENT_ICON_MAP = {
    ...
    "toolbar.debug": "DEVELOPER_TOOLS",
    "toolbar.refresh": "SYNC",
