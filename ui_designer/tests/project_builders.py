...
def build_saved_test_project_with_widgets_and_materialize_codegen(
    project_dir,
    app_name,
    sdk_root="",
    *,
    ...
    """Build, save, materialize, and return a single-page test project with page and root details."""
    return build_saved_project_model_with_widgets_and_materialize_codegen(
        app_name,
        page_name=page_name,
        screen_width=screen_width,
        screen_height=screen_height,
...
def build_saved_test_project_and_page_with_widgets_and_materialize_codegen(
    project_dir,
    app_name,
    sdk_root="",
    *,
    ...
    """Build, save, materialize, and return a single-page test project with its page."""
    return build_saved_project_model_and_page_with_widgets_and_materialize_codegen(
        app_name,
        page_name=page_name,
        screen_width=screen_width,
        screen_height=screen_height,
...
def build_saved_test_project_and_root_with_widgets_and_materialize_codegen(
    project_dir,
    app_name,
    sdk_root="",
    *,
    ...
    """Build, save, materialize, and return a single-page test project with its root widget."""
    return build_saved_project_model_and_root_with_widgets_and_materialize_codegen(
        app_name,
        page_name=page_name,
        screen_width=screen_width,
        screen_height=screen_height,
...
def build_saved_test_project_only_with_widgets_and_materialize_codegen(
    project_dir,
    app_name,
    sdk_root="",
    *,
    ...
    """Build, save, materialize, and return only the single-page test project and outputs."""
    return build_saved_project_model_only_with_widgets_and_materialize_codegen(
        app_name,
        page_name=page_name,
        screen_width=screen_width,
        screen_height=screen_height,
...
def build_saved_test_project_with_page_widgets_and_materialize_codegen(
    project_dir,
    app_name,
    sdk_root="",
    *,
    ...
    """Build, save, materialize, and return a multi-page test project with page roots."""
    return build_saved_project_model_with_page_widgets_and_materialize_codegen(
        app_name,
        screen_width,
        screen_height,
        sdk_root=sdk_root,
...
def build_saved_test_project_only_with_page_widgets_and_materialize_codegen(
    project_dir,
    app_name,
    sdk_root="",
    *,
    ...
    """Build, save, materialize, and return only the multi-page test project and outputs."""
    return build_saved_project_model_only_with_page_widgets_and_materialize_codegen(
        app_name,
        screen_width,
        screen_height,
        sdk_root=sdk_root,
