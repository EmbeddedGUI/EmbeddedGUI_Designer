...
class TestMainWindowFileFlow:
    ...
    def test_build_menu_actions_expose_status_hints(self, qapp, isolated_config, tmp_path):
        ...
        assert build_action.toolTip() == (
            ...
            "Source resources: missing. Resource directory: none. Release profiles: unavailable. Output root state: unavailable. History file state: unavailable. Release records: unavailable. "
            "Latest release: none. Latest release SDK: none. Release open targets: unavailable."
        )
