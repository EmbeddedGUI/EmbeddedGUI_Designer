...
class TestProjectExplorerDock:
    def test_accessibility_summary_tracks_project_current_and_dirty_pages(self, qapp):
        ...
        assert dock._page_tree.accessibleName() == "Project pages"
        assert dock._mode_combo.toolTip() == "Choose how pages are generated for the current project."
        assert dock._add_page_button.toolTip() == "Create a new page in the current project."
        assert dock._add_page_button.accessibleName() == "New page"
