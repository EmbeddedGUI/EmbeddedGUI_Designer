...
class TestResourceGeneratorWindow:
    ...
    def test_resource_generator_uses_compact_workspace_shell_spacing(self, qapp):
        ...
        try:
            ...
            assert _layout_margins_tuple(window._simple_asset_empty_state.layout()) == (16, 12, 16, 12)
            assert window._simple_asset_empty_state.layout().spacing() == 6
            ...
            assert window._simple_action_tabs.widget(0).layout().spacing() == 6
