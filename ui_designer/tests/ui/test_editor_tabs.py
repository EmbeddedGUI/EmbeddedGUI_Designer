...
class TestEditorTabsAccessibility:
    ...
    def test_header_exposes_editor_workspace_metadata(self, qapp):
        ...
        header_layout = tabs._header_frame.layout()
    ...
    def test_mode_switch_toolbar_exposes_accessible_mode_summary(self, qapp):
        ...
        toolbar_layout = tabs._mode_toolbar.layout()
        toolbar_margins = toolbar_layout.contentsMargins()
        ...
        assert (toolbar_margins.left(), toolbar_margins.top(), toolbar_margins.right(), toolbar_margins.bottom()) == (1, 1, 1, 1)
        assert toolbar_layout.spacing() == 2
        assert (shell_margins.left(), shell_margins.top(), shell_margins.right(), shell_margins.bottom()) == (1, 1, 1, 1)
